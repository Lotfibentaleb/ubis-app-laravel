<template>
  <card-component :title="$gettext('exportsPage.excelExportsSubSerial.card.title')" icon="package-variant-closed" class="tile is-child">
    <div class="column is-one-fifths is-offset-two-fifths">
      <p>{{$gettext('exportsPage.excelExportsSubSerial.explanation')}}</p>
    </div>
    <div class="column is-12">
      <b-field :label="$gettext('exportsPage.excelExportsSubSerial.articleNr')" :message="$gettext('exportsPage.excelExportsSubSerial.articleNr.message')" horizontal>
        <b-autocomplete
                :data="articleList"
                v-model="articleNr"
    ...
    <div class="column is-12">
      <b-field :label="$gettext('exportsPage.excelExportsSubSerial.serialNr')" :message="$gettext('exportsPage.excelExportsSubSerial.serialNr.message')" horizontal>
  ...
  export default {
    ...
    methods: {
      getHrefURL() {
        ...
        this.hrefUrl = this.dataUrl + '/fullExcelBySub?' + paramsFullExcel
      },
      setFilterValues() {
        let objData = {}
        if(this.articleNr != '') {
