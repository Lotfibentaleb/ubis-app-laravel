<template>
  ...
  <card-component :title="$gettext('bulkActionsPage.bulkReVerify.card.title')" icon="package-variant-closed" class="tile is-child">
    <div class="column is-one-fifths is-offset-two-fifths">
      <p>{{$gettext('bulkActionsPage.bulkReVerify.uploadComponents.title')}}</p>
    </div>
          ...
          <b-upload v-model="dropFiles"
            ...
            <section class="section">
              <div class="content has-text-centered">
                ...
                <p>{{$gettext('bulkActionsPage.bulkReVerify.uploadComponents.content')}}</p>
              </div>
            </section>
          </b-upload>
        </b-field>
    ...
    <div class="column is-12">
      <b-field :label="$gettext('bulkActionsPage.bulkReVerify.articleNr')" :message="$gettext('bulkActionsPage.bulkReVerify.articleNr.message')" horizontal>
        <b-autocomplete
                :data="articleList"
                v-model="articleNr"
    ...
    <div class="column is-1 is-offset-11">
      <b-button :label="$gettext('bulkActionsPage.bulkReVerify.reVerifyButton')" type="is-primary" @click="reVerify"></b-button>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      reVerify() {
        ...
        if(this.sectionId == '' || this.articleNr == '') {
        ...
        axios.post('/productlist/bulkreverify', data)
            .then(r => {
              if(r.data) {
