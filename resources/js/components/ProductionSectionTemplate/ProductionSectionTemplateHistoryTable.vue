  ...
  <div>
    ...
    <b-table
      ...
      <template slot-scope="props">
        <b-table-column label="name" field="updated_by">
          {{ props.row.name }}
        </b-table-column>
        <b-table-column label="measurement data" field="production_flow" centered>
            ...
            <div class="position-btn-detail">
              <div v-if="isShowProdDetailModal && selectedIndex == props.row.index" class="prod-detail-popup">
                <div class="prod-detail-text">
                  <b-input :value="JSON.stringify(JSON.parse(JSON.stringify(selectedRowData.data)))" type="textarea" readonly />
                </div>
...
<script>
  ...
  export default {
    name: 'ProductionSectionTemplateHistory',
            ...
            headers: {
              ...
              .then(r => {
                ...
                if (r.data && r.data.data) {
                  ...
                  this.pdSecTemHistory = r.data.data
                  this.pdSecTemHistory.forEach((productHistoryItem, index) => {
