<template>
  <div>
    ...
    <hero-bar>
      {{$gettext('productionSectionPage.heroBar.title')}}
      <p class="subtitle">
        {{$gettext('productionSectionPage.heroBar.subTitle')}}
      </p>
      <router-link slot="right" to="/products/section/new-template" class="button">
        {{$gettext('productionSectionPage.heroBar.goto')}}
      </router-link>
    </hero-bar>
    <section class="section is-main-section">
      <div class="columns">
        ...
        <div v-if="isClickedRow">
          <div class="column">
            <card-component :title="$gettext('productionSectionPage.settingPanel.title')" class="has-mobile-sort-spaced" icon="lead-pencil">
              <div class="level">
                ...
                <div class="level-right">
                  <div><b-button class="btn btn-ok" @click="savePdSecTemData" :disabled="!hasUpdatingData">{{$gettext('productionSectionPage.settingPanel.saveButton')}}</b-button></div>
                </div>
              </div>
              <b-field :label="$gettext('productionSectionPage.settingPanel.render')">
              ...
              <b-field :label="$gettext('productionSectionPage.settingPanel.group')">
              ...
              <b-field :label="$gettext('productionSectionPage.settingPanel.description')" :message="$gettext('productionSectionPage.settingPanel.fieldMessage')" expanded>
...
<script>
  ...
  export default {
    ...
    computed: {
      titleStack () {
        return [
          this.$gettext('productionSectionPage.titleBar.main'),
          this.$gettext('productionSectionPage.titleBar.sub1')
        ]
      },
    },
    data () {
