export default {
  "en": {
    ...
    "sidebar": {
      ...
      "template": "SETUP",
      "prodTemplate": "Production flows",
      "prodSection": "Production sections",
    ...
    "productsPage": {
      ...
      "heroBar": {
        "title": "Products",
        "subTitle": "Overview of alll transmitted / registered products",
        "goto": "Dashboard"
      },
      "productsTable": {
        "title": "Products",
    ...
    "productionFlowsPage": {
      ...
      "table": {
        "title": "Production process per article",
    ...
    "createUserPage": {
      ...
      "card": {
        ...
        "uuidPlaceholder": "The UUID will be created automatically when submitting",
        "role": "Role",
  ...
  "de": {
    ...
    "sidebar": {
      ...
      "prodTemplate": "Fertigungsabläufe",
      "prodSection": "Fertigungs-Stationen",
      "resource": "VERWALTUNG",
      "users": "Benutzer",
    },
    "topbar": {
    ...
    "productsPage": {
      ...
      "heroBar": {
        "title": "Produkte",
        "subTitle": "Übersicht aller übermittelter / angelegter Produkte",
        "goto": "Dashboard"
      },
      "productsTable": {
        "title": "Produkte",
        ...
        "fields": {
          ...
          "serialNr": "Serien-Nr.",
          "status": "Status",
          "productionDataCount": "Fertigungsdaten",
          "componentsCount": "Komponenten",
          "productionOrderNr": "Produktionsauftrag",
          "createdAt": "Erstellt",
        }
      },
      "productsSettingPanel": {
    ...
    "productionFlowsPage": {
      ...
      "heroBar": {
        "title": "Produktionsabläufe",
        "subTitle": "Übersicht der aktuell aktiven Produktionsabläufe je Artikel",
        "goto": "Neu Fertigungsabläufe"
      },
      "table": {
        "title": "Produktionsablauf je Artikel",
    ...
    "createUserPage": {
      ...
      "card": {
        ...
        "uuidPlaceholder": "Die UUID wird beim Senden automatisch erstellt",
        "role": "Rolle",
